# CORS Misconfiguration on bigpanda
...
- **Severity:** HIGH
- **Date:** 2026-06-07
- **Target:** https://api.bigpanda.io/api/v1/profile

---

## Summary

A CORS misconfiguration was discovered in the bigpanda API. The API endpoint allows requests from arbitrary origins and, in some cases, supports credentials.
...
```bash
curl -I -X OPTIONS 'https://api.bigpanda.io/api/v1/profile' \
...
*Report generated by SARAhack Mass CORS Scanner on 2026-06-07T15:26:16.135487*
