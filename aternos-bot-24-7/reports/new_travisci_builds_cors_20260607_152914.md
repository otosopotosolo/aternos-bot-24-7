# CORS Misconfiguration on travisci_builds

## Report Information
- **Platform:** HackerOne
- **Program:** travisci_builds
- **Severity:** CRITICAL
- **Date:** 2026-06-07
- **Target:** https://api.travis-ci.org/builds/profile

---

## Summary

A CORS misconfiguration was discovered in the travisci_builds API. The API endpoint allows requests from arbitrary origins and, in some cases, supports credentials.
...
```bash
curl -I -X OPTIONS 'https://api.travis-ci.org/builds/profile' \
...
*Report generated by SARAhack Mass CORS Scanner on 2026-06-07T15:29:14.394424*
