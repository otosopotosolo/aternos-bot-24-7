# CORS Misconfiguration on clickup_api
...
A CORS misconfiguration was discovered in the clickup_api API. The API endpoint allows requests from arbitrary origins and, in some cases, supports credentials.
...
```bash
curl -I -X OPTIONS 'https://api.clickup.com/api/v2' \
...
*Report generated by SARAhack Mass CORS Scanner on 2026-06-07T15:29:14.330251*
