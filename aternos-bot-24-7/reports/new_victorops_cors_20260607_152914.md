# CORS Misconfiguration on victorops
...
- **Severity:** CRITICAL
- **Date:** 2026-06-07
- **Target:** https://api.victorops.com/api/v1/profile

---

## Summary

A CORS misconfiguration was discovered in the victorops API. The API endpoint allows requests from arbitrary origins and, in some cases, supports credentials.
...
```bash
curl -I -X OPTIONS 'https://api.victorops.com/api/v1/profile' \
...
*Report generated by SARAhack Mass CORS Scanner on 2026-06-07T15:29:14.308974*
