# CORS Misconfiguration on travisci
...
- **Severity:** CRITICAL
- **Date:** 2026-06-07
- **Target:** https://api.travis-ci.org/profile

---

## Summary

A CORS misconfiguration was discovered in the travisci API. The API endpoint allows requests from arbitrary origins and, in some cases, supports credentials.
...
```bash
curl -I -X OPTIONS 'https://api.travis-ci.org/profile' \
...
*Report generated by SARAhack Mass CORS Scanner on 2026-06-07T15:29:14.356297*
