...
A Server-Side Request Forgery (SSRF) vulnerability was discovered in [endpoint], allowing an attacker to induce the server to make arbitrary HTTP requests to internal or external resources.
